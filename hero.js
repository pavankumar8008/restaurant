...
function displayItems(){
    ...
    const pannerData=foodItem.filter(item=> item.category=='panner');
...
function addToCart(){
    ...
    if(index=== -1){
        document.getElementById(itemObj.id).classList.add('toogle-heart');
...
function decrementItem(){
    ...
    if(decObj.quantity > 1){
        ...
        document.getElementById(decObj.id).classList.remove('toogle-heart');
        cartData.splice(ind,1);
        document.getElementById('cart-plus').innerText=' '+cartData.lenth+'Items';
        document.getElementById('m-cart-plus').innerText=' '+cartData.lenth;
